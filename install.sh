...
shell_download_link="https://raw.githubusercontent.com/shell12345/testOnly/master/install.sh"
program_version_link="https://raw.githubusercontent.com/shell12345/testOnly/master/version.sh"
...
fun_clangcn(){
    ...
    echo "+----------------------------------------------------------------+"
    echo "|  A tool to auto-compile & install on Linux                     |"
    echo "+----------------------------------------------------------------+"
